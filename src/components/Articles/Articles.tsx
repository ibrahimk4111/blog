    ...
    <div className=" px-2">
      ...
      <div className=" bg-slate-100 rounded-md overflow-hidden flex lg:flex-row flex-col justify-start items-center mb-5 group cursor-pointer relative ">
        ...
        <div className=" lg:absolute lg:left-80 lg:w-[50%] lg:bg-white p-4">
          ...
          <h5 className=" text-slate-600 group-hover:text-black">
            Nest Protect: 2nd Gen Smoke + CO Alarm.
          </h5>
          <p className=" text-sm text-slate-500 ">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae
            commodi sequi explicabo alias eos quidem iure, earum odio voluptates
            soluta necessitatibus amet aliquid eligendi iste atque. Ad tenetur
            totam eum!
          </p>
        </div>
      </div>
          ...
          <NavLink key={item.id} to={item.title} className=" text-decoration-none text-black ">
            ...
            >
              ...
              <div className=" space-y-3 p-4">
                <button className="text-sm text-slate-600 bg-slate-50 p-1 rounded-md ">
                  {item.tags[0]}
                </button>
