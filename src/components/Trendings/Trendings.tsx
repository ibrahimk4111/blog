  ...
  return (
    <Container className=" pb-5 px-2">
      ...
      <div className=" grid lg:grid-cols-12 gap-3">
        ...
        <div className=" lg:col-span-5 relative max-h-screen overflow-hidden ">
          <div className=" h-full rounded-md overflow-hidden ">
            ...
            <div className=" absolute bottom-0 left-0 w-full p-4 z-20 ">
              <div className=" ">
                  <p className="lg:mb-5 bg-slate-200/30 backdrop-blur-sm text-white md:block hidden uppercase font-semibold rounded-md p-2 w-32 text-center">Travel</p>
                  <h4 className=" font-semibold text-start text-white ">The 20 Biggest Fintech Companies In America 2019</h4>
        ...
        {/* small cards */}
        <div className=" lg:col-span-7 grid lg:grid-cols-3 gap-2">
          {articleData.map((item) => (
            ...
            >
              ...
              <div className=" flex flex-col justify-between gap-2 py-2 px-4 ">
